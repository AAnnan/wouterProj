...
Experiment='Wouter21_SING' #,'Wouter21_SING']
...
for sample in Samples:
    ...
    # Select cell called singlets in at least 1 modality
    #merged_df_all_singlet = merged_df_all[merged_df_all['doublet_class'].str.contains('Singlet')]
    # Select only singlets
    merged_df_all_singlet = merged_df_all[merged_df_all['doublet_class'] == 'Singlet Only']
...
for sample in Samples:
	...
	# Change index
	a.obs.index = a.obs.index + '_' + sample
	# Export
